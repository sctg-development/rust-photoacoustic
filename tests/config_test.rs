...
"#;
    ...
    assert!(result.is_ok(), "Valid YAML with IPv4 should pass validation");
...
"#;
    ...
    assert!(result.is_ok(), "Valid YAML with standard IPv6 should pass validation");
...
"#;
    ...
    assert!(result.is_ok(), "Valid YAML with IPv6 localhost should pass validation");
...
"#;
    ...
    assert!(result.is_ok(), "Valid YAML with IPv6 any address should pass validation");
...
"#;
    ...
    assert!(result.is_ok(), "Valid YAML with full IPv6 should pass validation");
...
"#;
    ...
    assert!(result.is_ok(), "Valid YAML with bracketed IPv6 should pass validation");
...
"#;
    ...
    assert!(result.is_err(), "YAML missing required field should fail validation");
...
"#;
    ...
    assert!(result.is_err(), "YAML with incorrect field names should fail validation");
...
"#;
    ...
    assert!(result.is_err(), "YAML with value outside allowed range should fail validation");
...
"#;
    ...
    assert!(result.is_ok(), "YAML with invalid address should pass with warning");
...
"#;
    ...
    assert!(result.is_err(), "YAML with invalid base64 certificate should fail validation");
...
"#;
    ...
    assert!(result.is_err(), "YAML with certificate but no key should fail validation");
