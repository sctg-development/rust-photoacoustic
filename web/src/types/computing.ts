...
export namespace ComputingUtils {
     ...
     */
    export function getLatestResult(response: ComputingResponse): PeakResultResponse | null {
     ...
     */
    export function getSortedResults(response: ComputingResponse): Array<{ nodeId: string, result: PeakResultResponse }> {
     ...
     */
    export function isNodeActive(response: ComputingResponse, nodeId: string): boolean {
     ...
     */
    export function getAverageConcentration(response: ComputingResponse): number | null {
        ...
        return concentrations.reduce((sum, ppm) => sum + ppm, 0) / concentrations.length;
    }
...
export namespace ComputingTypeGuards {
    ...
    export function isPeakResultResponse(obj: any): obj is PeakResultResponse {
        return (
            ...
            (obj.concentration_ppm === undefined || typeof obj.concentration_ppm === "number")
        );
    }
    ...
    export function isComputingResponse(obj: any): obj is ComputingResponse {
        return (
            ...
            (obj.peak_frequency === undefined || typeof obj.peak_frequency === "number") &&
            (obj.peak_amplitude === undefined || typeof obj.peak_amplitude === "number") &&
            (obj.concentration_ppm === undefined || typeof obj.concentration_ppm === "number") &&
            (obj.latest_result === undefined || isPeakResultResponse(obj.latest_result))
        );
    }
}
