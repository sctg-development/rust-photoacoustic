...
//! The modbus master is the device that requests data, while the modbus slave is the device that provides data.
//! In other words the modbus master is here the client and the modbus slave is here the server.
...
struct PhotoacousticModbusServer {
